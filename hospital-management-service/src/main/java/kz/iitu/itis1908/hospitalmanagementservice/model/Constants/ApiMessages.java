...
public class ApiMessages {
  ...
  public static final String PATIENT_NOT_FOUND = "Patient with such and id not found";
  public static final String DOCTOR_NOT_FOUND = "Doctor with such and id not found";
}
